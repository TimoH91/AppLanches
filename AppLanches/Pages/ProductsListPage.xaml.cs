...
public partial class ProductsListPage : ContentPage
{
    ...
    public ProductsListPage(int categoriaId, string categoriaNome, ApiService apiService, IValidator validador)
    {
        InitializeComponent();
        _apiService = apiService;
        _validator = validador;
        _categoriaId = categoriaId;
        Title = categoriaNome ?? "Products";  // Definindo o título da página
    ...
    private void CvProdutos_SelectionChanged(object sender, SelectionChangedEventArgs e)
    {
        ...
        Navigation.PushAsync(new ProductsDetailsPage(currentSelection.Id,
